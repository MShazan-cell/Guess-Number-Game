...
lblInst = tk.Label(window, text = "Guess a number from 0 to 9",fg="white",bg="#34A2FE",width=95)
lblLine0 = tk.Label(window, text = "*********************************************************************",fg="red")
lblNoGuess = tk.Label(window, text = "No of Guesses: 0",fg="black",bg="yellow",width=45)
lblMaxGuess = tk.Label(window, text = "Max Guess: 3",fg="black",bg="yellow",width=45)
lblLine1 = tk.Label(window, text = "*********************************************************************",fg="red")
lblLogs = tk.Label(window, text="Game Logs",fg="yellow",bg="black")
lblLine2 = tk.Label(window, text = "*********************************************************************",fg="red")
...
for index in range(0, 1):
    btnStartGame = tk.Button(window, text="Start Game",bg="blue",fg="yellow", command=lambda : startgame(index))
